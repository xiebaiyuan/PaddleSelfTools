...
source_model_dir="/data/paddle_yolo_nano_fp32_yongjia_saoma_1110/"
model_dir="/data/local/tmp/opencl/models/nanoyolo_saoma/"
...
cmd="export GLOG_v=0; /data/local/tmp/opencl/${testname} --model_dir=${model_dir} -N=1 -C=3 -H=416 -W=416 --optimized_model=/data/local/tmp/nanoyolo_saoma_self"
echo ${cmd}
adb shell ${cmd}
adb pull /data/local/tmp/nanoyolo_saoma_self.nb
