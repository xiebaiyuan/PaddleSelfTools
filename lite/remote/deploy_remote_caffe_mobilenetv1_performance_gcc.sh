...
pwd
scp Ubuntu_home:/workspace/Paddle-Lite/${build_dir}/inference_lite_lib.android.armv7.opencl/demo/cxx/mobile_light ./
adb push ./mobile_light /data/local/tmp/opencl/mobile_light
