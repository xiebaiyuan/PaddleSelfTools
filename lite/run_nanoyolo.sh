...
source_model_dir="/data/coremodels/Lens_YoloNano/checked_model/saved-20200226-013453"
...
adb shell "export GLOG_v=4; /data/local/tmp/opencl/${testname} --model_dir=${model_dir} --input_file=/data/local/tmp/opencl/${input} --output_file=/data/local/tmp/opencl/${output}"
