...
with_make=true
with_push=true
source_model_dir="/data/paddle_face_model/yyj_face_proj_fp32_128"
...
model_dir="/data/local/tmp/opencl/models/yyj_face_proj_fp32_128/"
...
cmd="export GLOG_v=0; /data/local/tmp/opencl/${testname} --model_dir=${model_dir} -N=1 -C=3 -H=128 -W=128 --optimized_model=/data/local/tmp/yyj_face_proj_fp32_128"
echo ${cmd}
adb shell ${cmd}
adb pull /data/local/tmp/yyj_face_proj_fp32_128.nb ./
md5sum yyj_face_proj_fp32_128.nb
cp yyj_face_proj_fp32_128.nb ${source_model_dir}
