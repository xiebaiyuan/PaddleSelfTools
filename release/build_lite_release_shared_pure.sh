...
# echo "修改线程数量"
# sed -i 's/readonly NUM_PROC=${LITE_BUILD_THREADS:-4}/readonly NUM_PROC=8 #${LITE_BUILD_THREADS:-4}/' ./lite/tools/build.sh
# sed -i 's/readonly NUM_PROC=${LITE_BUILD_THREADS:-4}/readonly NUM_PROC=8 #${LITE_BUILD_THREADS:-4}/' ./lite/tools/build_android.sh
# sed -i 's/readonly NUM_PROC=${LITE_BUILD_THREADS:-4}/readonly NUM_PROC=8 #${LITE_BUILD_THREADS:-4}/' ./lite/tools/ci_build.sh
